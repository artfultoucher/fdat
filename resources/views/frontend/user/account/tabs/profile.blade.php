<div class="table-responsive">
    <table class="table table-striped table-hover table-bordered">
        ...
        <tr>
            <th>Account role(s)</th>
            <td>@role('student') <i class="fas fa-user-graduate"></i> Student @endrole @role('lecturer') <i class="fas fa-chalkboard-teacher"></i> Lecturer @endrole</td>
        </tr>
        <tr>
